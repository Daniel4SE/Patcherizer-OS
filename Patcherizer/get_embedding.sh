...
python get_embedding.py -model ${SAVEPATH}/finetune/${BEST_MODEL} -vocab ${SAVEPATH}/vocab/vocab -src ${DATAPATH}/cleaned.test.diff -output ${SAVEPATH}/result/${LAYER}layer_${HEAD}head_${MASK_RATE}mask.msg -name ${DATAPATH}/test_cfr.pkl
